...
open class FloatRatingView: UIView {
    ...
    @IBInspectable open var emptyImageTintColor: UIColor? {
        didSet {
            for imageView in emptyImageViews {
                imageView.tintColor = emptyImageTintColor
            }
            refresh()
        }
    }
    ...
    @IBInspectable open var fullImageTintColor: UIColor? {
        didSet {
            for imageView in fullImageViews {
                imageView.tintColor = fullImageTintColor
            }
            refresh()
        }
    }
